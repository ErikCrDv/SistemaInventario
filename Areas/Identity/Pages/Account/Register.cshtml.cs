...
namespace SistemaInventario.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly RoleManager<IdentityRole> _roleManager; //VARIABLE PARA EL ROLE
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.CreateAsync(user, Input.Password);  //Creacion del usuario
                if (result.Succeeded)
                {
